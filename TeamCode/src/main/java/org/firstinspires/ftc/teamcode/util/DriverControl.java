...
import static org.firstinspires.ftc.teamcode.util.ECatchEDeliver.powerE;
...
public class DriverControl extends LinearOpMode {
    ...
    public DriverControl() throws Exception{
        telemetry.addLine("Start DriverControl");
    }
    Servo Intake;
    Servo ServoExtindor;
    Servo Puta;
    ...
    ElapsedTime timerThread = new ElapsedTime();
